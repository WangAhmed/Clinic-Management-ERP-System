...
namespace Appointment.Controllers
{
    public class PatientController : Controller
    {
        ...
        public ActionResult Edits()
        {
            ...
            s_Patient s_Patient = db.s_Patient.FirstOrDefault(p => p.PatientID == userId);
            if (s_Patient == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Edits([Bind(Include = "PatientID,regid,FirstName,LastName,DateOfBirth,Gender,ContactNumber,Email,Address")] s_Patient s_Patient, HttpPostedFileBase imageFile)
        {
            int? userId = Session["UserID"] as int?;
            if (userId == null || s_Patient.PatientID != userId)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
