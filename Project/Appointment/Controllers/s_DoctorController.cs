...
namespace Appointment.Controllers
{
    public class s_DoctorController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            if (id == null)
            {
                // Redirect to a generic error page or an appropriate action
            ...
            if (doctor == null)
            {
                // Redirect to a not found page or an appropriate action
                return RedirectToAction("NotFound", "Home");
            }

            // Redirect to the Details view with the appropriate ID
